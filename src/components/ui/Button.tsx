...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', loading, disabled, children, ...props }, ref) => {
    ...
    const variants = {
      primary: 'gradient-primary text-white shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 hover:scale-[1.02]',
      secondary: 'bg-slate-700 text-slate-200 hover:bg-slate-600 border border-slate-600 hover:border-slate-500',
      ...
      success: 'gradient-success text-white shadow-lg shadow-green-500/25 hover:shadow-green-500/40 hover:scale-[1.02]',
    };
